...
#define ACL_ALL_RIGHTS_DIRECTORY	(ACL_SELECT|ACL_UPDATE|ACL_CREATE)
...
extern AclMode pg_type_aclmask(Oid type_oid, Oid roleid,
				AclMode mask, AclMaskHow how);
extern AclMode pg_directory_aclmask(Oid dir_oid, Oid roleid, AclMode mask,
				AclMaskHow how);
...
extern AclResult pg_directory_aclcheck(Oid diroid, Oid roleid, AclMode mode);
...
extern bool has_setrole_privilege(Oid roleid);
...
extern bool has_readonly_privilege(Oid roleid);
